...
add_action( 'init', 'kad_woo_archive_image_output');
    ...
    add_action( 'woocommerce_before_main_content', 'kt_woo_main_wrap_content_open', 20 );
    ...
    add_action( 'woocommerce_before_main_content', 'kt_woo_product_breadcrumbs', 10 );
    ...
    add_action( 'woocommerce_above_main_content', 'kt_woocommerce_page_title_container', 10 );
    function kt_woocommerce_page_title_container() {
      get_template_part('templates/woo', 'page-title');
    }

    
    add_action( 'kt_woocommerce_page_title_left', 'kt_woocommerce_page_title_output', 20 );
    function kt_woocommerce_page_title_output() { ?>
      <h1 class="page-title"><?php woocommerce_page_title(); ?></h1>
    <?php } 
     add_action( 'woocommerce_before_main_content', 'woocommerce_result_count', 40 );

    // chnaged breadcrumbs from page_title_right to page_title_left
    add_action( 'kt_woocommerce_page_title_left', 'kt_woocommerce_page_title_shortcode', 10 );
